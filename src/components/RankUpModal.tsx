...
export function RankUpModal() {
 ...
 className="bg-white w-full max-w-sm rounded-[2.5rem] shadow-2xl overflow-hidden border-yellow-400 relative"
 >
 <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-2 pointer-events-none" />
 ...
 className={`w-32 h-32 mx-auto rounded-full flex items-center justify-center text-6xl border-white ${rank.bg}`}
 >
 {rank.icon}
 </motion.div>
 ...
 <button
 onClick={() => dispatch({ type:"CLOSE_RANK_POPUP" })}
 className="w-full bg-yellow-400 text-white py-4 rounded-2xl font-black text-xl active:scale-95 transition-transform border-yellow-600"
 >
 Awesome!
 </button>
 </div>
