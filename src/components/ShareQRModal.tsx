...
"p-6 rounded-3xl flex flex-col items-center relative overflow-hidden transition-colors duration-500 mx-auto",
 state.isStarkTheme ?"bg-black border-green-500" :"bg-[#ffde59] border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]"
 )}
 ...
 <h1 className={cn("text-4xl font-bold uppercase tracking-tighter", state.isStarkTheme ?"text-green-500" :"text-black")}>
 <b>MOODERIA</b>
 </h1>
 <div className={cn(
"px-3 py-1 rounded-full text-[10px] font-black mt-1 uppercase tracking-wider", 
...
"font-black text-2xl leading-tight break-words", 
 ...
 <div className={cn(
"absolute top-24 right-4 w-16 h-16 rounded-full flex items-center justify-center font-black text-[9px] rotate-12 z-20 opacity-90",
 state.isStarkTheme ?"border-green-500 text-green-500 bg-black" :" text-[#ff3b30] bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
 )}>
 <div className="-current rounded-full w-[52px] h-[52px] flex items-center justify-center text-center leading-none p-1 uppercase tracking-tighter">
 {type}
 </div>
 </div>
 ...
 {/* Date Stamp */}
 <div className={cn(
"mb-3 px-3 py-1 font-black text-[10px] uppercase tracking-widest",
 ...
 <div className={cn(
"p-3 rounded-2xl",
 state.isStarkTheme ?"bg-black border-green-500" :"bg-white border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rotate-1"
 )}>
 ...
 {/* Instructions */}
 <div className="mt-6 bg-red-50 p-4 rounded-2xl border-red-100">
 ...
 className="w-full py-4 bg-red-500 text-white rounded-2xl font-black uppercase tracking-widest hover:bg-red-600 transition-colors flex items-center justify-center gap-2 active:scale-95 disabled:opacity-50"
 >
