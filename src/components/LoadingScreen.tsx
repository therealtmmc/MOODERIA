...
export function LoadingScreen({ onComplete }: LoadingScreenProps) {
 ...
 if (isStark) {
 return (
 <div className="fixed inset-0 z-[100] bg-[#0a0c0a] flex flex-col items-center justify-center text-[#879E2A] font-mono overflow-hidden stark-theme">
 <div className="relative z-10 w-full max-w-xs flex flex-col items-center">
 <Terminal className="w-16 h-16 mb-6 animate-none" />
 <motion.h1 
 initial={{ opacity: 0 }}
 animate={{ opacity: 1 }}
 className="text-4xl font-bold tracking-widest mb-10 text-center uppercase"
 >
 code MOODERIA
 </motion.h1>

 <div className="w-full h-4 bg-[#0a0c0a] border-2 border-[#879E2A] rounded-none relative overflow-hidden">
 <motion.div 
 className="h-full bg-[#879E2A]"
 initial={{ width:"0%" }}
 ...
 <div className="w-full h-6 bg-black/30 rounded-full p-1 backdrop-blur-md border-white/10 shadow-inner">
 {/* Filling Bar */}
 <motion.div 
