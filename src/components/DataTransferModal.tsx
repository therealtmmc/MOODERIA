...
export function DataTransferModal({ isOpen, onClose }: DataTransferModalProps) {
 ...
 <div className="bg-indigo-50 border-indigo-100 p-4 rounded-2xl flex items-start gap-3">
 ...
 <div className="p-6 bg-gray-50 -t-2">
 <button
 onClick={handleGenerate}
 disabled={isOverLimit}
 className="w-full py-4 bg-indigo-600 text-white rounded-2xl font-black uppercase tracking-widest hover:bg-indigo-700 active:scale-95 transition-transform flex items-center justify-center gap-2 disabled:opacity-50 disabled:active:scale-100 disabled:active:translate-y-0 disabled:active:"
 >
...
function SelectionGroup({ title, items, selected, onToggle, onSelectAll, onClearAll, renderItem }: any) {
 ...
 <div className="bg-gray-50 p-3 flex justify-between items-center -b-2">
