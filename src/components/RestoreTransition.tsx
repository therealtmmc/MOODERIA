...
export function RestoreTransition() {
 ...
 animate={{ opacity: 1 }}
 exit={{ opacity: 0 }}
 className="fixed inset-0 z-[9999] bg-[#0a0c0a] text-[#879E2A] font-mono p-4 sm:p-8 overflow-hidden flex flex-col pointer-events-none stark-theme"
 >
 {phase ==='scrolling' && (
 ...
 {typedCode}
 <span className="animate-none">_</span>
 </div>
 )}
 ...
 className="w-3 h-5 bg-[#879E2A] inline-block align-middle ml-1"
 />
 </div>
 )}
 ...
 <div className="text-2xl sm:text-4xl font-bold tracking-widest uppercase">
 code MOODERIA
 </div>
 <motion.div 
