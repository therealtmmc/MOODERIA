...
export function ResonanceFeed() {
 ...
 <div className="flex justify-between items-center -b border-slate-100 pb-4">
 ...
 <div key={broadcast.id} className="bg-slate-50/80 rounded-2xl p-4 border-slate-100 transition-all hover:">
...
"{broadcast.message}"
 ...
 <div className="flex items-center justify-between pt-3 -t border-slate-200/60">
 <button 
