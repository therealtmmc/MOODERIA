...
export default function MarketPage() {
 ...
 { id:"_gold", name:"Gold Profile Border", description:"A shiny gold", price: 500, icon:"🖼️" },
 { id:"_diamond", name:"Diamond Profile Border", description:"A sparkling diamond", price: 1000, icon:"💎" },
 ];
 ...
 className="bg-purple-100 text-purple-600 p-3 rounded-xl active:scale-95 transition-transform border-purple-200 flex items-center gap-2"
 >
 ...
 className={cn(
"p-3 rounded-xl active:scale-95 transition-all flex items-center gap-2 font-bold text-xs",
 ...
 className="bg-white text-amber-600 p-3 rounded-xl active:scale-95 transition-transform border-amber-100"
 >
 ...
 <div className="bg-blue-50 border-blue-200 rounded-2xl p-4 flex items-center gap-4">
 ...
 <div className="bg-yellow-50 border-yellow-200 rounded-2xl p-4 flex items-center gap-4">
 ...
 className="bg-amber-50 border-amber-400 rounded-3xl p-6 relative overflow-hidden"
 >
 ...
 <div className="inline-flex items-center gap-2 bg-amber-400 text-white px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest">
...
"Citizens shall procure their groceries every <span className="text-amber-600 underline">{groceryDay}</span>!"
 ...
 <div className="flex justify-between bg-white p-2 rounded-2xl overflow-x-auto gap-2">
 {DAYS.map((day) => {
...
"flex flex-col items-center justify-center w-14 h-16 rounded-xl transition-all min-w-[56px]",
 ...
 isToday && !isSelected &&"bg-amber-50 text-amber-600 border-amber-100"
 )}
 >
...
"text-sm px-2 py-0.5 rounded-full",
 ...
 className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest transition-all bg-blue-500 text-white hover:bg-blue-600 active:scale-95"
 title="Share List"
 >
 ...
 className={cn(
"flex items-center gap-1 px-3 py-2 rounded-xl text-[10px] font-black uppercase tracking-tighter transition-all -b-2",
 isDecree ?"bg-amber-500 text-white" :"bg-gray-100 text-gray-500 border-gray-300 hover:bg-amber-100 hover:text-amber-600 hover:-amber-300"
 )}
 >
 ...
 layout
 className={cn(
"bg-white p-4 rounded-2xl flex justify-between items-center transition-colors",
...
"w-10 h-10 rounded-xl flex items-center justify-center",
 ...
 className="bg-amber-500 text-white px-4 py-2 rounded-xl font-black text-sm active:scale-95 transition-transform"
 >
 BUY
 </button>
 <button
 ...
 className="w-full bg-amber-500 text-white p-4 rounded-2xl transition-all flex items-center justify-between"
 >
 ...
 <div className="text-center py-12 opacity-50 -dashed rounded-3xl">
 ...
 <div className="space-y-4 pt-4 -t-2 -dashed">
 ...
 key={item.id}
 layout
 className="bg-gray-50 p-4 rounded-2xl flex justify-between items-center opacity-60"
 >
 <div className="flex items-center gap-3">
 ...
 className="bg-white text-gray-800 w-full max-w-sm rounded-3xl shadow-2xl overflow-hidden border-amber-500"
 >
 ...
 className="w-full p-3 bg-gray-50 rounded-xl focus:-amber-500 focus:outline-none font-bold"
...
"flex-1 py-2 rounded-lg text-xs font-black transition-all",
 newItem.type ==="liquid" ?"bg-white text-blue-600" :"text-gray-400"
 )}
 >
 LIQUID
 </button>
 ...
 className={cn(
"flex-1 py-2 rounded-lg text-xs font-black transition-all",
 newItem.type ==="solid" ?"bg-white text-amber-600" :"text-gray-400"
 )}
 >
 SOLID
 </button>
 ...
 className="w-full mt-4 bg-amber-500 text-white py-3 rounded-xl font-black active:scale-95 transition-transform disabled:opacity-50"
 >
 Add to List
 </button>
 </div>
 ...
 className={cn(
"flex-1 py-2 rounded-lg text-xs font-black transition-all",
 convertData.type ==="liquid" ?"bg-white text-blue-600" :"text-gray-400"
 )}
 >
 LIQUID
 </button>
 ...
 className={cn(
"flex-1 py-2 rounded-lg text-xs font-black transition-all",
 convertData.type ==="solid" ?"bg-white text-amber-600" :"text-gray-400"
 )}
 >
 SOLID
 </button>
 ...
 className="bg-white px-3 py-2 rounded-xl font-bold text-sm"
 >
 ...
 <div className="bg-amber-50 p-4 rounded-2xl border-amber-100">
 <div className="flex items-center gap-3">
 ...
 className="bg-white px-3 py-2 rounded-xl border-amber-200 font-bold text-sm"
 >
 {(convertData.type ==="liquid" ? LIQUID_UNITS : SOLID_UNITS).map(u => (
 <option key={u} value={u}>{u}</option>
 ))}
 ...
 animate={{ scale: 1, opacity: 1 }}
 exit={{ scale: 0.9, opacity: 0 }}
 className="bg-white text-gray-800 w-full max-w-md rounded-3xl shadow-2xl overflow-hidden border-purple-500"
 >
 ...
 className="bg-purple-500 text-white px-4 py-2 rounded-xl font-black text-sm active:scale-95 transition-transform border-purple-700 disabled:opacity-50 disabled:active:translate-y-0 disabled:active: flex items-center gap-1"
 >
 ...
 <div className="p-4 bg-gray-50 -t">
 <h4 className="font-black text-gray-700 mb-2">Your Inventory</h4>
 <div className="flex flex-wrap gap-2">
 {state.inventory.length > 0 ? (
 state.inventory.map((item, idx) => (
 <div key={idx} className="bg-white px-3 py-1 rounded-lg text-xs font-bold text-gray-600">
 {item.name}
 </div>
 ))
 ) : (
 ...
 animate={{ scale: 1, opacity: 1 }}
 exit={{ scale: 0.9, opacity: 0 }}
 className="bg-white text-gray-800 w-full max-w-sm rounded-3xl shadow-2xl overflow-hidden border-amber-500 p-6 text-center space-y-6"
 >
 ...
 <div className="bg-red-50 border-red-200 p-3 rounded-xl flex items-center gap-2 text-red-600 text-xs font-bold text-left">
 ...
 className="flex-1 bg-amber-500 text-white py-4 rounded-2xl font-black active:scale-95 transition-transform disabled:opacity-50 disabled:active:translate-y-0 disabled:active:"
 >
 CONFIRM
 </button>
 </div>
 ...
 <div key={item.id} className="flex justify-between items-center -b-2 pb-2">
 ...
 <div className="pt-4 -t-4 flex justify-between items-center">
 ...
 <div className="bg-red-50 border-red-200 p-3 rounded-xl flex items-center gap-2 text-red-600 text-xs font-bold text-left mt-4">
 <AlertTriangle className="w-4 h-4 shrink-0" />
 <span>Insufficient funds in bank! Please deposit money first in City Bank.</span>
 </div>
 )}
 ...
 className="flex-1 py-4 bg-amber-500 text-white rounded-2xl font-black uppercase tracking-widest hover:bg-amber-600 active:scale-95 transition-transform flex items-center justify-center gap-2 disabled:opacity-50 disabled:active:translate-y-0 disabled:active:"
 >
