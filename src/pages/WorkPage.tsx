...
export default function WorkPage() {
 ...
 className="bg-[#1368ce] text-white p-3 rounded-xl active:scale-95 transition-transform"
 >
 ...
 className="bg-[#fff8e1] rounded-3xl p-6 relative overflow-hidden"
 >
 ...
 <div className="inline-flex items-center gap-2 bg-[#d4af37] text-white px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest">
...
"{decreeTask.title}"
 ...
 className="w-full mt-2 bg-[#d4af37] hover:bg-[#c49f27] text-white py-3 rounded-xl font-black active:scale-95 transition-transform flex items-center justify-center gap-2"
 >
 ...
 {/* Week Day Selector */}
 <div className="flex justify-between bg-white p-2 rounded-2xl overflow-x-auto">
 {weekDays.map((day) => {
...
"flex flex-col items-center justify-center w-12 h-16 rounded-xl transition-all min-w-[48px]",
 isSelected 
 ?"bg-[#1368ce] text-white scale-105" 
 :"text-gray-400 hover:bg-gray-50",
 isToday && !isSelected &&"bg-blue-50 text-[#1368ce] border-blue-100"
 )}
 >
 ...
 <div className="text-center py-6 opacity-50 -dashed rounded-2xl">
 ...
 className={cn(
"bg-white p-4 rounded-2xl -l-8 flex justify-between items-center cursor-pointer active:scale-[0.98] transition-transform group",
 task.isDecree ?" bg-[#fffdf5]" :"border-orange-400"
 )}
 >
 <div>
...
"bg-white p-4 rounded-2xl -l-8 flex justify-between items-center cursor-pointer active:scale-[0.98] transition-transform group",
 ...
 className="bg-white text-gray-800 w-full max-w-sm rounded-[2rem] shadow-2xl overflow-hidden flex flex-col max-h-[80vh]"
 >
...
"w-full py-3 rounded-xl font-black text-sm flex items-center justify-center gap-2 transition-all",
 ...
 :"bg-[#fff8e1] text-[#d4af37] hover:bg-[#fffdf5]"
 )}
 >
 {selectedTask.isDecree ? (
 <>
 ...
 <div className="bg-gray-50 p-4 rounded-2xl min-h-[100px]">
 ...
 <div className="p-6 bg-gray-50 -t shrink-0 space-y-3">
 <button
 onClick={() => handleCompleteTask(selectedTask.id)}
 className={cn(
"w-full text-white py-4 rounded-2xl font-black text-lg active:scale-95 transition-transform flex items-center justify-center gap-2",
 selectedTask.isDecree ?"bg-[#d4af37]" :"bg-[#1368ce]"
 )}
 >
 ...
 {/* Routine Toggle */}
 <div className="flex items-center gap-3 bg-orange-50 p-3 rounded-xl border-orange-100">
 <div className={cn(
...
"w-4 h-4 bg-white rounded-full transition-transform",
 ...
 className="w-full p-3 bg-gray-50 rounded-xl focus: focus:outline-none font-medium h-24 resize-none"
 ...
 className="w-full mt-4 bg-[#1368ce] text-white py-3 rounded-xl font-black active:scale-95 transition-transform disabled:opacity-50"
 >
 Add Task
 </button>
 </div>
