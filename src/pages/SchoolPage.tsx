...
export default function SchoolPage() {
  ...
  return (
    <div className={cn("p-4 pt-8 pb-24 min-h-screen space-y-6 transition-colors duration-500", state.isStarkTheme && "stark-theme bg-black")}>
      ...
      {/* Breadcrumbs */}
      <div className={cn("flex items-center gap-2 p-3 rounded-xl", state.isStarkTheme ? "bg-green-900/20 border border-green-500/30" : "bg-white shadow-sm border border-gray-100")}>
        <button 
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <button
          ...
          className={cn("flex-1 py-3 rounded-xl font-bold flex items-center justify-center gap-2 transition-transform active:scale-95", 
            state.isStarkTheme ? "bg-black border border-green-500 text-green-400 hover:bg-green-900/30 font-mono" : "bg-indigo-100 text-indigo-700 hover:bg-indigo-200"
          )}
        >
        ...
        <button
          ...
          className={cn("flex-1 py-3 rounded-xl font-bold flex items-center justify-center gap-2 transition-transform active:scale-95", 
            state.isStarkTheme ? "bg-black border border-green-500 text-green-400 hover:bg-green-900/30 font-mono" : "bg-pink-100 text-pink-700 hover:bg-pink-200"
          )}
        >
        ...
        <button
          ...
          className={cn("flex-1 py-3 rounded-xl font-bold flex items-center justify-center gap-2 transition-transform active:scale-95", 
            state.isStarkTheme ? "bg-green-500 text-black border border-green-400 hover:bg-green-400 font-mono" : "bg-indigo-600 text-white hover:bg-indigo-700"
          )}
        >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        {folders.map(folder => (
          <div key={folder.id} className={cn("p-4 rounded-2xl border-2 flex flex-col items-center gap-2 relative group cursor-pointer transition-transform hover:scale-105", 
            state.isStarkTheme ? "bg-black border-green-500/30 hover:border-green-500" : "bg-white border-gray-100 shadow-sm hover:shadow-md"
          )}>
            ...
            {editingFolderId === folder.id ? (
              <div className="w-full flex flex-col gap-2" onClick={e => e.stopPropagation()}>
                <input 
                  ...
                  className={cn("w-full text-center text-sm p-1 rounded", state.isStarkTheme ? "bg-green-900/20 border border-green-500 text-green-400 font-mono" : "border border-gray-300")}
                />
        ...
        {files.map(file => (
          <div key={file.id} className={cn("p-4 rounded-2xl border-2 flex flex-col items-center gap-2 relative group cursor-pointer transition-transform hover:scale-105", 
            state.isStarkTheme ? "bg-black border-green-500/30 hover:border-green-500" : "bg-white border-gray-100 shadow-sm hover:shadow-md"
          )}>
            <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
        ...
        {flashcardDecks.map(deck => (
          <div key={deck.id} className={cn("p-4 rounded-2xl border-2 flex flex-col items-center gap-2 relative group cursor-pointer transition-transform hover:scale-105", 
            state.isStarkTheme ? "bg-black border-green-500/30 hover:border-green-500" : "bg-white border-pink-100 shadow-sm hover:shadow-md hover:border-pink-300"
          )}>
            <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
        ...
        {isCreateFolderModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <motion.div 
              ...
              className={cn("w-full max-w-sm p-6 rounded-3xl shadow-2xl", state.isStarkTheme ? "bg-black border border-green-500 font-mono" : "bg-white")}
            >
              ...
              <input 
                ...
                className={cn("w-full p-3 rounded-xl mb-4 outline-none border-2", 
                  state.isStarkTheme ? "bg-green-900/20 border-green-500/50 text-green-400 placeholder:text-green-700 focus:border-green-400" : "bg-gray-50 border-gray-200 focus:border-indigo-500"
                )}
              />
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              ...
              <input 
                ...
                className={cn("w-full p-3 rounded-xl mb-4 outline-none border-2", 
                  state.isStarkTheme ? "bg-green-900/20 border-green-500/50 text-green-400 placeholder:text-green-700 focus:border-green-400" : "bg-gray-50 border-gray-200 focus:border-pink-500"
                )}
              />
              <div className="flex gap-3">
        ...
        {editingDeck && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <motion.div 
              ...
              animate={{ opacity: 1, scale: 1 }}
              exit={{ opacity: 0, scale: 0.95 }}
              className={cn("w-full max-w-2xl max-h-[90vh] flex flex-col rounded-3xl shadow-2xl", state.isStarkTheme ? "bg-black border border-green-500 font-mono" : "bg-white")}
            >
              <div className={cn("p-4 flex justify-between items-center border-b", state.isStarkTheme ? "border-green-500/30 bg-green-900/20" : "border-gray-100")}>
              ...
              <div className="flex-1 overflow-auto p-4 space-y-4">
                {editingDeck.cards.map((card, index) => (
                  <div key={card.id} className={cn("p-4 rounded-xl border relative", state.isStarkTheme ? "bg-green-900/10 border-green-500/30" : "bg-gray-50 border-gray-200")}>
                ...
                <div className={cn("p-4 rounded-xl border-2 border-dashed", state.isStarkTheme ? "border-green-500/50" : "border-gray-300")}>
                  ...
                  <input 
                    ...
                    className={cn("w-full p-3 rounded-xl mb-3 outline-none border-2", 
                      state.isStarkTheme ? "bg-black border-green-500/50 text-green-400 placeholder:text-green-700 focus:border-green-400" : "bg-white border-gray-200 focus:border-pink-500"
                    )}
                  />
                  <textarea 
                    ...
                    placeholder="Answer..."
                    rows={3}
                    className={cn("w-full p-3 rounded-xl mb-3 outline-none border-2 resize-none", 
                      state.isStarkTheme ? "bg-black border-green-500/50 text-green-400 placeholder:text-green-700 focus:border-green-400" : "bg-white border-gray-200 focus:border-pink-500"
                    )}
                  />
                  <button 
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md">
            ...
            >
              ...
              {playingDeck.cards.length === 0 ? (
                <div className={cn("p-12 text-center rounded-3xl", state.isStarkTheme ? "bg-black border border-green-500 text-green-400" : "bg-white text-gray-800")}>
                ...
                <div className="flex flex-col items-center">
                  ...
                  >
                    ...
                    >
                      {/* Front (Question) */}
                      <div className={cn("absolute inset-0 backface-hidden rounded-3xl p-8 flex flex-col items-center justify-center text-center shadow-2xl border-4", 
        ...
        {previewFile && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
            <motion.div 
              ...
              exit={{ opacity: 0, y: 20 }}
              className={cn("w-full max-w-4xl max-h-[90vh] flex flex-col rounded-3xl overflow-hidden shadow-2xl", state.isStarkTheme ? "bg-black border border-green-500 font-mono" : "bg-white")}
            >
              <div className={cn("p-4 flex justify-between items-center border-b", state.isStarkTheme ? "border-green-500/30 bg-green-900/20" : "border-gray-100")}>
              ...
              <div className="flex-1 overflow-auto p-4 flex items-center justify-center min-h-[50vh] bg-gray-50/50 dark:bg-black/50">
                {isLoadingPreview ? (
                  ...
                  <>
                    ...
                    {previewText && (
                      <div className={cn("w-full h-full text-left whitespace-pre-wrap p-6 rounded-xl overflow-auto", state.isStarkTheme ? "bg-green-900/10 text-green-400" : "bg-white shadow-sm text-gray-800")}>
                        {previewText}
                      </div>
                    )}
