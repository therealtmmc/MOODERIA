...
"font-bold",
 ...
 className="bg-indigo-100 text-indigo-600 p-2 rounded-xl border-indigo-200 active:scale-95 transition-transform"
 >
 ...
 className="bg-[#fdfbf7] w-full max-w-sm rounded-[2rem] shadow-2xl overflow-hidden flex flex-col max-h-[80vh]"
 >
 ...
 className="w-full p-3 bg-white rounded-xl focus: focus:outline-none font-bold text-gray-700"
 />
 ...
 className="w-full h-48 p-4 bg-white rounded-xl focus: focus:outline-none resize-none font-medium text-gray-700 leading-relaxed"
 placeholder="Dear Future Me, I hope you have achieved..."
 />
 </div>
 </div>

 <div className="p-6 bg-white -t shrink-0">
 <button
 onClick={handleSaveFutureLetter}
 disabled={!futureLetterText}
 className="w-full bg-[#8b5cf6] text-white py-4 rounded-2xl font-black text-lg active:scale-95 transition-transform flex items-center justify-center gap-2 disabled:opacity-50"
 >
...
"px-4 py-2 rounded-full text-xs font-bold whitespace-nowrap transition-all",
 isSelected 
 ? `${MOOD_COLORS[mood]} text-white scale-105 ` 
 ...
 className="w-full h-40 p-4 bg-gray-50 rounded-2xl focus: focus:outline-none resize-none font-medium text-gray-700 text-sm mb-4 leading-relaxed z-10 relative bg-transparent"
...
"flex-1 py-3 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all",
 ...
 <button
 className={cn(
"w-full h-full py-3 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all pointer-events-none",
 lockDate
...
"w-full py-3 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all",
 image ?"bg-blue-100 border-blue-400 text-blue-700" :"bg-gray-50 text-gray-400 hover:bg-gray-100"
 )}>
 ...
 <button className={cn(
"w-full py-3 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all",
 video ?"bg-purple-100 border-purple-400 text-purple-700" :"bg-gray-50 text-gray-400 hover:bg-gray-100"
 )}>
...
"flex-1 py-3 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all",
 ...
 className="w-full bg-[#1368ce] text-white py-4 rounded-2xl font-black active:scale-95 transition-transform flex items-center justify-center gap-2 disabled:opacity-50 disabled:active:scale-100 disabled:cursor-not-allowed"
 >
 ...
 <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-6 rounded-3xl text-white relative overflow-hidden">
 ...
 <div key={entry.date} className="bg-white/20 backdrop-blur-sm p-4 rounded-xl border-white/10">
...
"text-xs font-bold px-3 py-1 rounded-full transition-colors flex items-center gap-1",
 ...
 className={cn(
"relative aspect-[3/4] rounded-r-2xl rounded-l-md -l-8 flex flex-col justify-between p-4 overflow-hidden group cursor-pointer",
...
"border-black/20" // Book spine effect
 ...
 {entry.isHighlight && <Trophy className="w-5 h-5 text-yellow-300 fill-yellow-300 drop-" />}
 </div>
...
"p-6 text-white flex justify-between items-center",
 ...
 {selectedEntry.image && (
 <img src={selectedEntry.image as string} alt="Diary" className="w-full rounded-2xl" />
 )}
