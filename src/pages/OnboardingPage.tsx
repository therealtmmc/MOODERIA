...
export default function OnboardingPage() {
 ...
 <div className="absolute inset-0 bg-[linear-gradient(rgba(70,23,143,0.9),rgba(70,23,143,0.8)),url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-10"></div>
 </div>
 ...
 className="absolute inset-0 border-white/20 -t-white rounded-full"
 />
 ...
 <p className="text-white/60 font-bold text-sm">Accessing <b>MOODERIA</b> City Database...</p>
 </motion.div>
 )}
 </AnimatePresence>
 ...
 className="bg-[#f0f2f5] w-full max-w-md rounded-[2.5rem] shadow-2xl overflow-hidden border-white/20 relative z-10"
 >
 {/* Header Section */}
 ...
 <div className="w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center backdrop-blur-sm border-white/20 mb-4 shadow-inner transform rotate-3 relative overflow-hidden group">
 ...
 <h1 className="text-3xl font-bold text-white uppercase tracking-wider drop-">
 <b>MOODERIA</b>
 </h1>
 <p className="text-white/60 font-bold text-xs uppercase tracking-[0.2em] mt-2 bg-white/10 px-3 py-1 rounded-full border-white/5">
 The Virtual City
 </p>
 </div>
 </div>
 ...
 <div className="bg-white rounded-3xl p-6 space-y-6 relative overflow-hidden">
 
 {/* Photo Upload */}
 <div className="text-center -mt-16 mb-8 relative z-10">
 <label className="relative inline-block cursor-pointer group">
 <div className="w-28 h-28 bg-gray-100 rounded-2xl mx-auto border-white flex items-center justify-center overflow-hidden group-hover:scale-105 transition-transform relative">
 {photo ? (
 ...
 <div className="absolute -bottom-2 -right-2 bg-[#eb6123] text-white p-2 rounded-xl border-white transform rotate-3 group-hover:rotate-6 transition-transform">
 ...
 <div className={`relative group bg-gray-50 rounded-2xl transition-colors ${isFocused ==='name' ?' bg-white' :' hover:'}`}>
 ...
 <div className={`relative group bg-gray-50 rounded-2xl transition-colors ${isFocused ==='citizenship' ?' bg-white' :' hover:'}`}>
 <div className="absolute left-4 top-4 text-gray-400">
 ...
 className="w-full bg-[#46178f] hover:bg-[#3a1378] text-white py-4 rounded-2xl font-black text-lg shadow-[0_4px_0_0_#2f0f60] active:shadow-none transition-all disabled:opacity-50 disabled:active:translate-y-0 disabled:shadow-none mt-4 flex items-center justify-center gap-2 group relative overflow-hidden"
 >
