...
export default function HealthPage() {
 ...
 {workoutStreak > 0 && (
 <div className="flex items-center gap-1 bg-orange-100 px-3 py-1 rounded-full border-orange-200">
 ...
 {/* Boss Battle UI */}
 <div className="bg-gray-900 rounded-3xl p-6 shadow-2xl relative overflow-hidden border-gray-800">
 ...
 <div className="bg-red-500/20 text-red-400 px-3 py-1 rounded-full text-xs font-black uppercase tracking-widest border-red-500/30">
 Level {state.boss.level} Boss
 </div>
 
 <h2 className="text-3xl font-black text-white drop-">{state.boss.name}</h2>
 
 <div className="w-32 h-32 bg-gray-800 rounded-full flex items-center justify-center border-gray-700 shadow-inner relative">
 <motion.div 
 animate={{ y: [0, -10, 0] }} 
 ...
 <div className="h-4 bg-gray-800 rounded-full overflow-hidden border-gray-700">
 <motion.div 
 ...
 {/* Streak Visualizer */}
 {workoutStreak > 0 && (
 <div className="bg-gradient-to-r from-orange-500 to-red-600 p-4 rounded-3xl text-white relative overflow-hidden">
 ...
 >
 <Flame className="w-6 h-6 text-yellow-300 fill-yellow-300 drop-" />
 </motion.div>
 ))}
 {workoutStreak > 14 && (
...
"font-black text-lg",
 ...
 className="w-full bg-[#e21b3c] text-white p-4 rounded-2xl transition-all flex items-center justify-between disabled:opacity-50 disabled:active:translate-y-0 disabled:active:"
 >
 ...
 disabled={isActive || isWalking}
 className="w-full bg-white text-[#e21b3c] p-4 rounded-2xl transition-all flex items-center justify-between disabled:opacity-50"
 >
 ...
 className="bg-white p-4 rounded-2xl relative overflow-hidden group cursor-pointer hover: transition-colors"
 >
...
"bg-green-100 text-green-600"
 ...
 disabled={isActive || isWalking}
 className="bg-[#e21b3c] text-white px-4 py-2 rounded-xl font-black text-sm active:scale-95 transition-transform flex items-center gap-2 disabled:opacity-50"
 >
 ...
 disabled={isActive}
 className={cn(
"w-full p-4 rounded-2xl transition-all flex items-center justify-between disabled:opacity-50",
 isWalking
 ?"bg-gray-800 text-white border-gray-900"
 :"bg-white text-[#e21b3c]"
 )}
 >
 ...
 exit={{ opacity: 0, y: 50 }}
 className="bg-white p-6 rounded-3xl shadow-2xl mt-4"
 >
 ...
 <div className={cn(
"w-64 h-64 rounded-full flex items-center justify-center relative mx-auto transition-colors duration-500",
 activeRoutine[currentStepIndex].type ==="rest" ?"border-blue-400 bg-blue-500/20" :"border-white/30"
 )}>
 <div className="absolute inset-0 rounded-full border-white animate-spin duration-[3s]" />
 <span className="text-8xl font-black font-mono">{timeLeft}</span>
 </div>
 ) : (
 <div className="w-64 h-64 rounded-full border-white/30 flex flex-col items-center justify-center relative mx-auto bg-white/10">
...
"w-3 h-3 rounded-full transition-colors",
 ...
 <button
 onClick={nextStep}
 className="w-full bg-white text-[#e21b3c] px-8 py-4 rounded-2xl font-black text-xl active:scale-95 transition-transform flex items-center justify-center gap-2"
 >
 ...
 className="bg-white text-gray-800 w-full max-w-sm rounded-3xl shadow-2xl overflow-hidden max-h-[85vh] flex flex-col"
 >
 ...
 className="w-full p-2 rounded-lg border-gray-300 font-bold text-sm"
 />
 ...
 className="p-2 rounded-lg border-gray-300 font-bold text-sm bg-white"
 >
 ...
 {/* Add Rest Form */}
 <div className="bg-blue-50 p-3 rounded-xl border-blue-200 space-y-3">
 ...
 className="w-full p-2 rounded-lg border-blue-200 font-bold text-sm"
 />
 <button
 onClick={() => {
 ...
 <div className="bg-orange-50 p-3 rounded-xl border-orange-200 space-y-3">
 ...
 className="w-full p-2 rounded-lg border-orange-200 font-bold text-sm"
 />
 ...
 className="p-2 rounded-lg border-orange-200 font-bold text-sm bg-white flex-1"
 >
 ...
 <div className="p-4 -t bg-gray-50 shrink-0">
 <button
 onClick={() => startCustomRoutine()}
 disabled={builderSteps.length === 0}
 className="w-full bg-[#e21b3c] text-white py-3 rounded-xl font-black active:scale-95 transition-transform disabled:opacity-50 disabled:active:scale-100"
 >
 Start Now (One-time)
 </button>
 </div>
 ...
 <div key={index} className="bg-gray-50 p-3 rounded-xl relative">
 {index > 0 && (
 <button 
 ...
 className="w-full p-2 rounded-lg border-gray-300 font-bold text-gray-700 text-sm"
 />
 </div>
 ...
 className="w-full py-3 -dashed border-gray-300 rounded-xl text-gray-400 font-bold text-sm hover: hover:text-[#e21b3c] transition-colors"
 >
 ...
 className="w-full bg-[#e21b3c] text-white py-3 rounded-xl font-black active:scale-95 transition-transform"
 >
 Save Log
 </button>
 </div>
 ...
 animate={{ scale: 1, opacity: 1 }}
 exit={{ scale: 0.9, opacity: 0 }}
 className="bg-white text-gray-800 w-full max-w-sm rounded-3xl shadow-2xl overflow-hidden max-h-[80vh] overflow-y-auto"
 >
 ...
 className="w-full bg-gray-50 hover:bg-gray-100 p-4 rounded-2xl text-left transition-colors flex items-center gap-4 group"
 >
 <div className={cn("w-16 h-16 rounded-xl flex items-center justify-center text-2xl", program.color)}>
 💪
 </div>
 <div>
 ...
 <div key={index} className="bg-gray-50 p-4 rounded-2xl flex items-center gap-4">
 ...
 disabled={isActive || isWalking}
 className="flex-1 py-4 bg-[#e21b3c] text-white rounded-2xl font-black uppercase tracking-widest hover:bg-[#c01733] active:scale-95 transition-transform flex items-center justify-center gap-2 disabled:opacity-50"
 >
